...
import cn.datacraft.typing.TypingWebSocketHandler;
...
@Configuration
@EnableWebSocket
public class TypingWebSocketConfig implements WebSocketConfigurer {
    private final TypingWebSocketHandler handler;

    public TypingWebSocketConfig(TypingWebSocketHandler handler) {
        this.handler = handler;
    }

    @Override
    public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
        registry.addHandler(handler, "/ws/tools/typing")
