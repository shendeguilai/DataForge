...
public class JobRepository {
    ...
    public JobRepository(JobRecordJpaRepository records, ObjectMapper mapper) { this.records = records; this.mapper = mapper; }
    ...
    public GenerationJob save(GenerationJob job) {
        ...
        record.artifactPath = job.getArtifact() == null ? null : job.getArtifact().toString();
    ...
    private GenerationJob toDomain(JobRecord record) {
        ...
        if (record.artifactPath != null) job.setArtifact(Paths.get(record.artifactPath));
