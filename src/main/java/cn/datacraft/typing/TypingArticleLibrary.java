...
public class TypingArticleLibrary {
    private final List<Article> articles = Collections.unmodifiableList(Arrays.asList(
            new Article("binary-search", "二分答案的边界", "算法思想",
            ...
            new Article("graph-search", "图搜索与访问标记", "图论基础",
            ...
            new Article("prefix-sum", "前缀和的区间视角", "数据结构",
            ...
            new Article("dynamic-programming", "动态规划的状态设计", "算法思想",
            ...
            new Article("complexity", "复杂度与数据范围", "竞赛习惯",
            ...
            new Article("disjoint-set", "并查集维护连通性", "数据结构",
            ...
            new Article("shortest-path", "最短路算法的选择", "图论基础",
            ...
            new Article("testing", "用样例之外的数据检查程序", "竞赛习惯",
            ...
            new Article("memory-model", "变量、栈与堆空间", "计算机基础",
            ...
            new Article("contest-routine", "稳定的比赛解题流程", "竞赛习惯",
